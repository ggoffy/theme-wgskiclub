                ...
                <td width="100%" align="center" valign="top">
                    ...
                    <table class='apcalEventlist' width='100%' class='outer' cellpadding='4' cellspacing='1'>
                        <tr valign='middle'>
                            ...
                            <{if $isAdmin}>
                                <th class='head width10'><{$lang_categories}></th>
                                <th class='head width20'><{$lang_rrule}></th>
                                <th class='head width10'><{$lang_admission}></th>
                            <{/if}>
                        ...
                        <{foreach item='event' from=$events}>
                            <tr>
                                ...
                                <{if $isAdmin}>
                                    <td class='<{$event.oddeven}> width10'><{$event.maincat}></td>
                                    <td class='<{$event.oddeven}> width20'><{$event.rrule}></td>
                                    <td class='<{$event.oddeven}> width10' align='center'>
                                        <{$event.admission}>
