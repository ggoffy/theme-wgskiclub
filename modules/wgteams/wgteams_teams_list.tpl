...
<{else}>    
    ...
    <{/if}>
            ...
            <{if $team.team_read_more}>
                <div class="team-readmore"><a href="<{$wgteams_url_index}>?team_id=<{$team.team_id}>" class="btn btn-primary" alt="<{$team.team_read_more}>" title="<{$team.team_read_more}>"><{$team.team_read_more}></a></div>
            <{/if}>
        </div>
    </div>
<{/if}>
