    ...
    <div class="row">
        <div class="xoops-site-closed col-md-6 col-md-offset-3">
            ...
            <div class="aligncenter site-closed-logo">
                <img src="<{$xoops_imageurl}>images/logo-header.png" style="height:75px;margin:0 20px;" alt="<{$lang_login}>">
                <img src="<{$xoops_imageurl}>images/wedega_150075.png" style="height:75px;margin:0 20px;"  alt="<{$lang_login}>">
            </div>
            ...
            <div class="xoops-site-closed-container">
                ...
                <form action="<{xoAppUrl user.php}>" method="post" role="form" class="form-horizontal">
                    ...
                    <div class="input-container">
                        ...
                        <span class="glyphicon glyphicon-user" style="background-color:#ffffff;" ></span>
                    </div>
                    ...
                    <div class="input-container">
                        ...
                        <span class="glyphicon glyphicon-lock" style="background-color:#ffffff;" ></span>
                    </div>
