...
<{if $results}>        
	...
	<div class="item" style="font-size: 12px;">
	    <h4 style="margin-bottom: 1px; padding-bottom: 0px;"><a href="<{$result.link}>"><{$result.title}></a></h4>
...
<form name="search" action="search.php" method="post" class="form-horizontal" role="form">
	...
	<div class="form-group">
	  <label class="col-sm-2 control-label"><{$smarty.const._CO_WGNEWS_CATEGORY}></label>
	  <div class="col-sm-10">
	    <{$category_select}>
	  </div>
	</div>
	...
	<div class="form-group">
	  <label class="col-sm-2 control-label"><{$smarty.const._CO_WGNEWS_UID}></label>
	  <div class="col-sm-10">
	    <input type="text" name="uname" class="form-control" value="<{$search_user}>" placeholder="<{$smarty.const._CO_WGNEWS_UID}>">
	  </div>
	</div>
	<div class="form-group">
	  <label class="col-sm-2 control-label"><{$smarty.const._CO_WGNEWS_SORTBY}></label>
	  <div class="col-sm-10">
	    <{$sortby_select}>
	  </div>
	</div>
        ...
        <tr>
            <td>
                <table border="0" cellpadding="1" cellspacing="1" width="100%" class="head">
                    ...
                    <tr>
                        <td class="head" align="right">
                            <strong><{$smarty.const._CO_WGNEWS_CATEGORY}></strong>
                        </td>
                    ...
                    <tr>
                        <td class="head" align="right">
                            <strong><{$smarty.const._CO_WGNEWS_UID}></strong>&nbsp;
                        </td>
                        <td class="even">
                    ...
                    <tr>
                        <td class="head" align="right">
                            <strong><{$smarty.const._CO_WGNEWS_SORTBY}></strong>&nbsp;
                        </td>
