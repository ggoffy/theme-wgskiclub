<form name="search" action="<{$block.wgnews_url}>/search.php" method="post">
    <table class="outer" border="0" cellpadding="1" cellspacing="0" align="center" width="95%">
        ...
        <tr>
            <td class="even">
                <strong><{$smarty.const._CO_WGNEWS_CATEGORY}></strong></td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="even">
                <strong><{$smarty.const._CO_WGNEWS_UID}></strong>&nbsp;</td>
        </tr>
        <tr>
            <td class="odd">
        ...
        <!-- <tr>
           <td class="head" align="right"><strong><{$smarty.const._CO_WGNEWS_SORTBY}></strong>&nbsp;</td>
