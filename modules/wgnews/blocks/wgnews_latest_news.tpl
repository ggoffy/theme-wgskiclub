...
<{if $block.template == 'extended'}>
    ...
    <{php}>
        $GLOBALS['xoTheme']->addStylesheet(WGNEWS_URL . '/assets/css/jquery.popeye.css');
        $GLOBALS['xoTheme']->addStylesheet(WGNEWS_URL . '/assets/css/jquery.popeye.style.css');
        $GLOBALS['xoTheme']->addStylesheet(WGNEWS_URL . '/assets/css/wgnews.css');
    <{/php}>
...
<{if $block.template == 'slider2'}>
    ...
    <{php}>$GLOBALS['xoTheme']->addScript('browse.php?Frameworks/jquery/jquery.js');
        ...
        $GLOBALS['xoTheme']->addStylesheet(WGNEWS_URL . '/assets/css/jquery.popeye.style.css');
        $GLOBALS['xoTheme']->addStylesheet(WGNEWS_URL . '/assets/css/wgnews.css');
        $GLOBALS['xoTheme']->addScript(WGNEWS_URL . '/assets/js/jquery.easing.js');
        $GLOBALS['xoTheme']->addScript(WGNEWS_URL . '/assets/js/script.easing.js');<{/php}>
    <script type="text/javascript">
        jQuery(document).ready(function () {
