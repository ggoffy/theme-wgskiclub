<div class="item">
        ...
        <{if $display_whowhen_link}>
            <div class="itemInfo">
                <span class="itemPoster">
                    <div class="wginfos_item_head_who">
    ...
    <div class="itemBody">
        <{if $item.image_path}>
            <a href="<{$item.itemurl}>" title="<{$item.title}>"><img class="wginfos_item_image" src="<{$item.image_path}>" align="right" alt="<{$item.title}>" width="100"></a>
        <{/if}>
    ...
    <{if $op != 'preview' && $item.body}>
        <div align="right">
            <a href="<{$item.itemurl}>"> <{$smarty.const._MD_WGINFOS_VIEW_MORE}></a>&nbsp;
        </div>
    <{/if}>
    ...
    <div class="wginfos_pre_itemInfo">
        <div class="itemInfo" style="height: 14px;">
            ...
            <{if $display_comment_link && $item.cancomment && $item.comments != -1 && $com_rule != 0}>
                <span style="float: left;"><a href="<{$item.itemurl}>"><{$item.comments}> <{$smarty.const._MD_WGINFOS_COMMENTS}></a></span>
            <{else}>
